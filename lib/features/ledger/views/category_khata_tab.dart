...
/// Ek tab ka content — sirf us category ke naam (no mix).
class CategoryKhataTab extends StatelessWidget {
  const CategoryKhataTab({super.key, required this.category});
